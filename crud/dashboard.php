...
<body>
  ...
  <div class="d-flex justify-content-end mt-3">
      <a href="../UserDashboard/userdashboard.php" class="btn btn-danger me-2">Dashboard User</a>
      ...
      <tbody>
        ...
        if (count($product) > 0) {
          foreach ($product as $row) {
            ...
            echo "<td>";
            echo "<a href='ubah.php?id=" . $row['id'] . "' class='btn btn-primary btn-sm mb-2 ms-2'>Edit</a>";
            echo "<a href='hapus.php?id=" . $row['id'] . "' class='btn btn-danger btn-sm ms-2'>Delete</a>";
            echo "</td>";
            echo "</tr>";
          }
        } else {
